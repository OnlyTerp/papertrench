...
`extension/price-bridge.js` (`forwardTokenActivity`); `quote.js` (`notePoolTrade`, `poolConsensusVerdict`); `content.js` (`handlePageTick` pool gate) · gmgn.ai · found during the C-32 investigation · **fixed**
