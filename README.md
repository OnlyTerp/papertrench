...
[![Tests](https://img.shields.io/badge/tests-1631%20passing-34D399?style=flat-square)](#tests)
...
1,631 tests covering price resolution, tick validation, portfolio arithmetic, the Padre chart bridge, fresh-launch handling, the positions bar, session replay, the attestation chain, and browser-context loading.
